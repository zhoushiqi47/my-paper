...
We consider imaging of a Dirichlet, a Neumann, a Robin bounday, and a penetrable obstacle. The imaging domain
 ...
 \begin{figure}
 	\centering
 	\includegraphics[width=0.24\textwidth]{./graphic/circle_2pi.eps}
 	\includegraphics[width=0.24\textwidth]{./graphic/circle_2pi_neumann.eps}
 	\includegraphics[width=0.24\textwidth]{./graphic/circle_2pi_impedance.eps}
 	\includegraphics[width=0.24\textwidth]{./graphic/circle_2pi_transmission.eps}
