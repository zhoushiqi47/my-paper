...
\begin{figure}
	\centering
	\includegraphics[width=\textwidth]{./graphic/new_path.png}
...
\begin{figure}
	\centering
	\includegraphics[width=\textwidth]{./graphic/transformation.png}
...
\bigskip
\textbf{Example 1}.
We consider imaging of a Dirichlet, a Neumann, a Robin bounday, and a penetrable obstacle. The imaging domain
 $\om = (−2; 2) \times (8; 12)$ with the sampling grid $201 \times 201$ and $N_s = N_r = 401$. The angular frequency is $\om=2\pi$.
 \begin{figure}
 	\centering
 	...
 	\includegraphics[width=0.24\textwidth]{./graphic/circle_3pi_impedance.eps}
