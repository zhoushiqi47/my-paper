...
\ben
\sum_{t'=\pm t_R}{\rm Res}(\mathbb{N}_0(t)\cos (t+\phi)e^{\i \lam\cos t},t')=\frac \i 2\sum_{\xi=\pm k_R}\sum_{\al=p,s}\frac{\Na(\xi)}{\de'(\xi)}e^{\i (y_2\mu_\al+(x_1-y_1)\xi)}.
\een
...
&&+\int^{k_R+d_R}_{k_R-d_R}\frac{g(\xi)\de_1(\xi)^{-1}-g(k_R)\de_1(k_R)^{-1}}{(\xi-k_R)(\xi+k_R)}d\xi.
\ee
